...
public class ScreenPanel extends JPanel implements ActionListener {
    ...
    private void loadIcons() {
        ...
        ImageIcon iisnakepart = new ImageIcon("snakepart.png");
        snakepart = iisnakepart.getImage();

        ImageIcon iiapple = new ImageIcon("apple.png");
        apple = iiapple.getImage();

        ImageIcon iisnakehead = new ImageIcon("snakehead.png");
    ...
    /* set size of screen variables and other variables used in the program */
